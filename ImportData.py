...
class DataImporter:
    ...
    def import_data(self):
        ...
        for interval in intervals:
            url = f"https://api.twelvedata.com/time_series?apikey={twelvedata_api_key}&interval={interval}&symbol={self.symbol}&start_date={self.start}&format=CSV&dp=8&timezone=utc"
